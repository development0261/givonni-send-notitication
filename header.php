...
<head>
   ...
   <!--  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastify-js/1.6.1/toastify.css" integrity="sha512-VSD3lcSci0foeRFRHWdYX4FaLvec89irh5+QAGc00j5AOdow2r5MFPhoPEYBUQdyarXwbzyJEO7Iko7+PnPuBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    ...
    <script>
       const BASE_URL="http://localhost/php_task";
    </script>
</head>
<body>
<?php
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
       <!--  <a class="navbar-brand" href="#">Php Task</a> -->
        ...
        <li class="nav-item">
            <a class="nav-link <?= ($activePage == "SendNotification") ? 'active' : '' ?>" aria-current="page" href="SendNotification.php">Send Notification</a>
          </li>
         
          <li class="nav-item">
            <a class="nav-link <?= ($activePage == "display_notification") ? 'active' : '' ?>" aria-current="page" href="display_notification.php">Notification Status</a>
          </li>
        <li class="nav-item">
